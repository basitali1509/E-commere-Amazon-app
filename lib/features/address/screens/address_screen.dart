...
import 'package:e_commerce/common/bottom_bar.dart';
          ...
          child: Column(
            children: [
              ...
              //     ),
                  ...
                  child: const Center(child: Text('Pay', style: TextStyle(fontSize: 18, color: Colors.black),)),
                ),
              )
            ],
          ),
